...
Android 우선 네이티브 애니 시청 기록 앱입니다. 기존 Streamlit/WebView 앱과 별개로 새로 시작하며, 데이터는 앱 내부 JSON 파일과 JSON 백업/복원으로 관리합니다.
...
- `lib/src/features/home`: 새 화, 보관함, 보류, 찜, 신작 애니
- `lib/src/features/detail`: 상세, 시즌, 에피소드, 극장판/영화
- `lib/src/features/news`: 애니 소식, 뉴스 상세, 내부 WebView
